...
type: 'arXiv'  # Options: Conference, Journal, Dissertation, Patent, arXiv
year: 2024
venue: ''
pdfUrl: 'https://arxiv.org/pdf/2407.13922'  # Optional - put PDF in public/pdfs/
link: 'https://arxiv.org/abs/2407.13922'  # Optional - makes title clickable
bibtex: |  # Optional - custom BibTeX entry (use | for multiline)
  @article{ramesh2024synthetic,
  title={Synthetic Counterfactual Faces},
  author={Guruprasad V Ramesh, Harrison Rosenberg, Ashish Hooda, Shimaa Ahmed, Kassem Fawaz},
