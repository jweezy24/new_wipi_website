...
authors: 'Harrison Rosenberg (co-first), Shimaa Ahmed (co-first), Guruprasad V Ramesh (co-first), Kassem Fawaz, Ramya Korlakai Vinayak'
...
bibtex: |  # Optional - custom BibTeX entry (use | for multiline)
  ...
  author={ Harrison Rosenberg (co-first), Shimaa Ahmed (co-first), Guruprasad V Ramesh (co-first), Kassem Fawaz, Ramya Korlakai Vinayak},
  journal={AAAI},
  year={2024}}

focus: ['systems', 'ai', 'math']  # Options: systems, people, math, ai
---
